      ...
      <div class="container">
        <nav class="nav">
          ...
          <div class="nav-links">
            ...
            <router-link to="/batch" class="nav-link">Batch</router-link>
            <router-link to="/data-import" class="nav-link">Data Import</router-link>
            <router-link to="/settings" class="nav-link">Settings</router-link>
          </div>
          <div class="nav-right">
            <a :href="sparkUiUrl" target="_blank" class="spark-ui-link" title="Open Spark Web UI">
...
// Spark UI runs on :4060 of whatever host is serving the app, so derive it
// from the current hostname rather than hardcoding localhost (which is dead
// for anyone viewing a screen-share or a forwarded port).
const sparkUiUrl = `${location.protocol}//${location.hostname}:4060`
